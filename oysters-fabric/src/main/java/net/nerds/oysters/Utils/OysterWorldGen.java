    ...
    public static void createOysterFeature(Biome biome) {
            if (biome.getCategory() == Biome.Category.OCEAN) {
                biome.addFeature(
                    ...
                    new ConfiguredFeature(new OysterGenerationFeature(DefaultFeatureConfig.CODEC,OysterBreed.BLEMISHED.getOysterBlock().getDefaultState()), FeatureConfig.DEFAULT)
                );
            }
        }
}
